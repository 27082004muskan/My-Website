...
const About = () => {
  ...
  <div className="relative">
    <div className="w-80 h-80 bg-gradient-to-br from-pink-400 to-purple-600 rounded-2xl flex items-center justify-center shadow-2xl transform hover:scale-105 transition-transform duration-300">
    ...
    <div className="absolute -top-4 -right-4 w-16 h-16 bg-pink-500 rounded-full animate-pulse"></div>
    <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-purple-500 rounded-full animate-bounce"></div>
  </div>
</div>
